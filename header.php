...
<header class="row" role="banner">
	<div class="small-12 columns">
		<h4 class="subheader"><h1 class="logo"><a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_url') ?>/logo.png" alt="<?php bloginfo('description'); ?>" title="<?php bloginfo('name'); ?>" /></a></h1></h4>
